...
const Error404 = () => {
  ...
  return (
    <div className='containerError404'>
        ...
        <img className='logoError404' src= "https://res.cloudinary.com/dvrxw8fbg/image/upload/q_auto:low/v1660659301/CryptocupQatar/error404/Logo_hqnvty.png"/* {logo} */ alt="Logo" />
    </div>
  )
}
