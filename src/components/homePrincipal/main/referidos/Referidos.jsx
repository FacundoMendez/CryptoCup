  ...
  return (
    <div className='containerReferidos'>
        ...
        <div className="textsReferidos">
            <h2>refer to earn</h2>
            <p>The referral system allowed you to bring people and get a huge discount and the oportunity to you to get big rewards <br /> <br /> <span> For every people who bougth a ticket with your referral code, <br /> you get <span className='spanColor'>$1 USDT</span> , and they get a discount of <span className='spanColor'>$4 USDT</span></span></p>
        </div>
