    ...
    return(
        <>
            <div className="social">
                ...
                <a href="https://t.me/cryptocupqatar" target="_blank" rel="noopener noreferrer"><i className="telegramSocial"> <FontAwesomeIcon icon={faTelegram} /> </i> Telegram  </a>
                <a href="https://discord.gg/ckFmn9xXhw" target="_blank" rel="noopener noreferrer"><i className="discordSocial"> <FontAwesomeIcon icon={faDiscord} /> </i>Discord </a>
            </div>
            ...
            <div className="socialMobile">
                ...
                <a href="https://t.me/cryptocupqatar" target="_blank" rel="noopener noreferrer"><i className="telegramSocial"> <FontAwesomeIcon icon={faTelegram} /> </i>  </a>
                <a href="https://discord.gg/ckFmn9xXhw" target="_blank" rel="noopener noreferrer"><i className="discordSocial"> <FontAwesomeIcon icon={faDiscord} /> </i> </a>
            </div>
